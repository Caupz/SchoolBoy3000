...
class FridayRoute extends StatefulWidget{
  final String title;
  FridayRoute({Key key, @required this.title}) : super(key : key);

  @override
  _FridayRouteState createState() => _FridayRouteState();
}


class _FridayRouteState extends State<FridayRoute>{
  String dropdownSubject = "Teoreetiline informaatika";
  String dropdownDay = "Friday";
          ...
          return new Scaffold(
            ...
            body: Column(children: <Widget>[
              Container(
                  ...
                  child: new Text("Fill in your lesson plan for friday",
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Add subject to friday plan',
                    ...
                    onPressed: () {
                      ...
                      // builder: (BuildContext context) => new Friday("Friday")),);
                    },
                  )
              ),
            ]),
