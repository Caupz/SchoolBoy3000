...
class WednesdayRoute extends StatefulWidget{
  final String title;
  WednesdayRoute({Key key, @required this.title}) : super(key : key);

  @override
  _WednesdayRouteState createState() => _WednesdayRouteState();
}


class _WednesdayRouteState extends State<WednesdayRoute>{
  String dropdownSubject = "Teoreetiline informaatika";
  String dropdownDay = "Wednesday";
          ...
          return new Scaffold(
            ...
            body: Column(children: <Widget>[
              Container(
                  ...
                  child: new Text("Fill in your lesson plan for wednesday",
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Add subject to wednesdays plan',
                    ...
                    onPressed: () {
                      ...
                      // builder: (BuildContext context) => new Wednesday("Wednesday")),);
                    },
                  )
              ),
            ]),
