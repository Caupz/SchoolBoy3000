...
class TuesdayRoute extends StatefulWidget{
  final String title;
  TuesdayRoute({Key key, @required this.title}) : super(key : key);

  @override
  _TuesdayRouteState createState() => _TuesdayRouteState();
}


class _TuesdayRouteState extends State<TuesdayRoute>{
  String dropdownSubject = "Teoreetiline informaatika";
  String dropdownDay = "Tuesday";
          ...
          return new Scaffold(
            ...
            body: Column(children: <Widget>[
              Container(
                  ...
                  child: new Text("Fill in your lesson plan for tuesday",
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Add subject to tuesdays plan',
                    ...
                    onPressed: () {
                      ...
                      // builder: (BuildContext context) => new Tuesday("Tuesday")),);
                    },
                  )
              ),
            ]),
