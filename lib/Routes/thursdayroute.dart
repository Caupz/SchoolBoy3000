...
class ThursdayRoute extends StatefulWidget{
  final String title;
  ThursdayRoute({Key key, @required this.title}) : super(key : key);

  @override
  _ThursdayRouteState createState() => _ThursdayRouteState();
}


class _ThursdayRouteState extends State<ThursdayRoute>{
  String dropdownSubject = "Teoreetiline informaatika";
  String dropdownDay = "Thursday";
          ...
          return new Scaffold(
            ...
            body: Column(children: <Widget>[
              Container(
                  ...
                  child: new Text("Fill in your lesson plan for thursday",
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Add subject to thursdays plan',
                    ...
                    onPressed: () {
                      ...
                      // builder: (BuildContext context) => new Thursday("Thursday")),);
                    },
                  )
              ),
            ]),
