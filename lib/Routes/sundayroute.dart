...
class SundayRoute extends StatefulWidget{
  final String title;
  SundayRoute({Key key, @required this.title}) : super(key : key);

  @override
  _SundayRouteState createState() => _SundayRouteState();
}


class _SundayRouteState extends State<SundayRoute>{
          ...
          return new Scaffold(
            ...
            body: Column(children: <Widget>[
              Container(
                  ...
                  child: new Text("Fill in your lesson plan for sunday",
              ...
              Container(
                  ...
                  child: RaisedButton(
                    ...
                    child: Text('Add subject to sunday plan',
                    ...
                    onPressed: () {
                      ...
                      //model.addSubjectEntry(1, "Sunday", subject, startTime, endTime, room, transportType, departureTime, true, true);
                      // Navigator.of(context).push(new MaterialPageRoute(
                      // builder: (BuildContext context) => new Sunday("Sunday")),);
                    },
                  )
              ),
            ]),
