...
class Wednesday extends StatelessWidget {
  ...
  Widget buildBody(BuildContext ctxt, int index, MainModel model) {
    List<SubjectEntry> list = model.subjectEntries
        .where((i) => i.selectedDay == "Wednesday")
        .toList();
            ...
            child: new IconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(ctxt).push(new MaterialPageRoute(
                    builder: (BuildContext context) => Wednesday("")));
              },
            ),
          ),
        ],
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(new MaterialPageRoute(
                        builder: (BuildContext context) => WednesdayRoute(
                              title: "WednesdayRoute",
                            )));
                  },
                )),
            Container(
                ...
                child: model.subjectEntries
                        ...
                        .toList()
                        .isNotEmpty
                    ? Text('All subjects on wednesday:',
                        style: TextStyle(fontSize: 20))
                    : Text("There are no subjects on wednesday")),
