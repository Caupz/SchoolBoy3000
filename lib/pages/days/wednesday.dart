...
import 'package:schoolboy3000/Routes/wednesdayroute.dart';
          ...
          Container(
            child: new IconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(ctxt).push(new MaterialPageRoute(builder: (BuildContext context)=> Wednesday("")));              },
            ),
          ),
        ],
      ),
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: (){
                        ...
                        Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=> WednesdayRoute(title: "WednesdayRoute",)));
                      },
                    )
                ),
                Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    child: Text('All subjects on wednesday:', style: TextStyle(fontSize: 20))
                ),
