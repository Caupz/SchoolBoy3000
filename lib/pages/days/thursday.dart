...
class Thursday extends StatelessWidget {
  ...
  Widget buildBody(BuildContext ctxt, int index, MainModel model) {
    List<SubjectEntry> list =
        model.subjectEntries.where((i) => i.selectedDay == "Thursday").toList();
            ...
            child: new IconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(ctxt).push(new MaterialPageRoute(
                    builder: (BuildContext context) => Thursday("")));
              },
            ),
          ),
        ],
          ...
          body: Column(children: <Widget>[
                ...
                child: RaisedButton(
                  ...
                  onPressed: () {
                    ...
                    Navigator.of(context).push(new MaterialPageRoute(
                        builder: (BuildContext context) => ThursdayRoute(
                              title: "ThursdayRoute",
                            )));
                  },
                )),
            Container(
                ...
                child: model.subjectEntries
                        .where((i) => i.selectedDay == "Thursday")
                        .toList()
                        .isNotEmpty
                    ? Text('All subjects on thursday:',
                        style: TextStyle(fontSize: 20))
                    : Text("There are no subjects on thursday")),
