...
import 'package:schoolboy3000/Routes/thursdayroute.dart';
          ...
          Container(
            child: new IconButton(
              ...
              onPressed: () {
                ...
                Navigator.of(ctxt).push(new MaterialPageRoute(builder: (BuildContext context)=> Thursday("")));              },
            ),
          ),
        ],
      ),
                ...
                Container(
                    ...
                    child: RaisedButton(
                      ...
                      onPressed: (){
                        ...
                        Navigator.of(context).push(new MaterialPageRoute(builder: (BuildContext context)=> ThursdayRoute(title: "ThursdayRoute",)));
                      },
                    )
                ),
                Container(
                    ...
                    width: MediaQuery.of(context).size.width,
                    child: Text('All subjects on thursday:', style: TextStyle(fontSize: 20))
                ),
